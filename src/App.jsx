...
import enemyData1 from "./data/initialEnemyData";


export default function App() {
  const [gameRunning, setGameRunning] = useState(false);
  const [enemiesData, setEnemiesData] = useState(enemyData1);
    ...
    <div className="wrapper">
      <div className="meadow-container">
        <div className="castle-container">
          ...
          {enemiesData.map((enemiesData, index) => (
            <Enemy key={index} currentImage={enemiesData.currentImage} position={enemiesData.position} orientation={enemiesData.orientation} />
          ))}
